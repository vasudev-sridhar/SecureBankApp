...
import com.asu.secureBankApp.Request.OtpRequest;
...
public class OtpServiceImpl{ 
	...
	public OtpResponse generateotp(@Valid OtpRequest otpRequest) {
		OtpResponse response = new OtpResponse();
		return response;
	}
	
	public OtpResponse generateotp1(@Valid OtpRequest otpRequest) {
		OtpResponse response = new OtpResponse();
		return response;
	}
	...
	public String generateCurrentNumberString(String base32Secret) throws GeneralSecurityException {
	...
	String zeroPrepend(int num, int digits) {
