...
public class SecurityConfig extends WebSecurityConfigurerAdapter
{
    ...
    protected void configure(HttpSecurity http) throws Exception 
    {
        http
			...
			.antMatchers("/api/transaction/balance", "/api/transaction/transfer").hasAnyAuthority("AUTHORIZE_CUSTOMER_TRANSFER_REQUEST")
			.antMatchers("/api/transaction/approve/*").hasAnyAuthority("AUTHORIZE_CRITICAL_TRANSACTIONS")
